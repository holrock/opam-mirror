...
(* OASIS_START *)
(* DO NOT EDIT (digest: 1ad0e079ff6b436a5841a7a4bce81bd5) *)
(*
...
let setup_t =
  {
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("opam-lib.repository", None);
                           FindlibPackage ("threads", None)
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
     ...
     oasis_digest = Some "\166\b*\158\183gP\173\132\2440{_\131\231\149";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
